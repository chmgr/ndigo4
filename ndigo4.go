...
func RecvRecordingGetFilename(pInstance *RecvInstanceT) *byte {
	cpInstance, cpInstanceAllocMap := (C.NDIlib_recv_instance_t)(unsafe.Pointer(pInstance)), cgoAllocsUnknown
...
func RecvRecordingGetError(pInstance *RecvInstanceT) *byte {
	cpInstance, cpInstanceAllocMap := (C.NDIlib_recv_instance_t)(unsafe.Pointer(pInstance)), cgoAllocsUnknown
...
func RecvGetWebControl(pInstance *RecvInstanceT) *byte {
	cpInstance, cpInstanceAllocMap := (C.NDIlib_recv_instance_t)(unsafe.Pointer(pInstance)), cgoAllocsUnknown
