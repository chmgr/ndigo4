...
/*
#cgo LDFLAGS: -L/usr/local/lib -lndi.4 -Wl,-rpath=\$ORIGIN/lib
#include <stdlib.h>
...
func (x *FindCreateT) PassRef() (*C.NDIlib_find_create_t, *cgoAllocMap) {
	...
	ref298166dd.p_groups, cp_groups_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PGroups)))
	allocs298166dd.Borrow(cp_groups_allocs)

	var cp_extra_ips_allocs *cgoAllocMap
	ref298166dd.p_extra_ips, cp_extra_ips_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PExtraIps)))
...
func (x *FindCreateT) Deref() {
	...
	hxfc4425b := (*sliceHeader)(unsafe.Pointer(&x.PGroups))
	hxfc4425b.Data = unsafe.Pointer(x.ref298166dd.p_groups)
	hxfc4425b.Cap = 0x7fffffff
	// hxfc4425b.Len = ? x.PGroups x.ref298166dd.p_groups

	hxf95e7c8 := (*sliceHeader)(unsafe.Pointer(&x.PExtraIps))
	hxf95e7c8.Data = unsafe.Pointer(x.ref298166dd.p_extra_ips)
	hxf95e7c8.Cap = 0x7fffffff
	// hxf95e7c8.Len = ? x.PExtraIps x.ref298166dd.p_extra_ips
...
func (x *RecvCreateV3T) PassRef() (*C.NDIlib_recv_create_v3_t, *cgoAllocMap) {
	...
	ref2125df04.p_ndi_recv_name, cp_ndi_recv_name_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PNdiRecvName)))
...
func (x *RecvCreateV3T) Deref() {
	...
	hxff2234b := (*sliceHeader)(unsafe.Pointer(&x.PNdiRecvName))
	hxff2234b.Data = unsafe.Pointer(x.ref2125df04.p_ndi_recv_name)
	hxff2234b.Cap = 0x7fffffff
	// hxff2234b.Len = ? x.PNdiRecvName x.ref2125df04.p_ndi_recv_name
...
func (x *RoutingCreateT) PassRef() (*C.NDIlib_routing_create_t, *cgoAllocMap) {
	...
	reffc210a9.p_ndi_name, cp_ndi_name_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PNdiName)))
	allocsfc210a9.Borrow(cp_ndi_name_allocs)

	var cp_groups_allocs *cgoAllocMap
	reffc210a9.p_groups, cp_groups_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PGroups)))
...
func (x *RoutingCreateT) Deref() {
	...
	hxff73280 := (*sliceHeader)(unsafe.Pointer(&x.PNdiName))
	hxff73280.Data = unsafe.Pointer(x.reffc210a9.p_ndi_name)
	hxff73280.Cap = 0x7fffffff
	// hxff73280.Len = ? x.PNdiName x.reffc210a9.p_ndi_name

	hxfa9955c := (*sliceHeader)(unsafe.Pointer(&x.PGroups))
	hxfa9955c.Data = unsafe.Pointer(x.reffc210a9.p_groups)
	hxfa9955c.Cap = 0x7fffffff
	// hxfa9955c.Len = ? x.PGroups x.reffc210a9.p_groups
...
func (x *SendCreateT) PassRef() (*C.NDIlib_send_create_t, *cgoAllocMap) {
	...
	var cp_ndi_name_allocs *cgoAllocMap
	ref85a33e95.p_ndi_name, cp_ndi_name_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PNdiName)))
	allocs85a33e95.Borrow(cp_ndi_name_allocs)

	var cp_groups_allocs *cgoAllocMap
	ref85a33e95.p_groups, cp_groups_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PGroups)))
...
func (x *SendCreateT) Deref() {
	...
	hxfa3f05c := (*sliceHeader)(unsafe.Pointer(&x.PNdiName))
	hxfa3f05c.Data = unsafe.Pointer(x.ref85a33e95.p_ndi_name)
	hxfa3f05c.Cap = 0x7fffffff
	// hxfa3f05c.Len = ? x.PNdiName x.ref85a33e95.p_ndi_name

	hxf0d18b7 := (*sliceHeader)(unsafe.Pointer(&x.PGroups))
	hxf0d18b7.Data = unsafe.Pointer(x.ref85a33e95.p_groups)
	hxf0d18b7.Cap = 0x7fffffff
	// hxf0d18b7.Len = ? x.PGroups x.ref85a33e95.p_groups
...
func (x *SourceT) PassRef() (*C.NDIlib_source_t, *cgoAllocMap) {
	...
	var cp_ndi_name_allocs *cgoAllocMap
	ref667670a2.p_ndi_name, cp_ndi_name_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PNdiName)))
...
func (x *SourceT) Deref() {
	...
	hxf2fab0d := (*sliceHeader)(unsafe.Pointer(&x.PNdiName))
	hxf2fab0d.Data = unsafe.Pointer(x.ref667670a2.p_ndi_name)
	hxf2fab0d.Cap = 0x7fffffff
	// hxf2fab0d.Len = ? x.PNdiName x.ref667670a2.p_ndi_name
...
func (x *VideoFrameV2T) PassRef() (*C.NDIlib_video_frame_v2_t, *cgoAllocMap) {
	...
	refffd8086c.p_metadata, cp_metadata_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PMetadata)))
...
func (x *VideoFrameV2T) Deref() {
	...
	hxf69fe70 := (*sliceHeader)(unsafe.Pointer(&x.PMetadata))
	hxf69fe70.Data = unsafe.Pointer(x.refffd8086c.p_metadata)
	hxf69fe70.Cap = 0x7fffffff
	// hxf69fe70.Len = ? x.PMetadata x.refffd8086c.p_metadata
...
func (x *AudioFrameV2T) PassRef() (*C.NDIlib_audio_frame_v2_t, *cgoAllocMap) {
	...
	var cp_metadata_allocs *cgoAllocMap
	ref7f2b41d7.p_metadata, cp_metadata_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PMetadata)))
...
func (x *AudioFrameV2T) Deref() {
	...
	hxf65bf54 := (*sliceHeader)(unsafe.Pointer(&x.PMetadata))
	hxf65bf54.Data = unsafe.Pointer(x.ref7f2b41d7.p_metadata)
	hxf65bf54.Cap = 0x7fffffff
	// hxf65bf54.Len = ? x.PMetadata x.ref7f2b41d7.p_metadata
...
func (x *AudioFrameV3T) PassRef() (*C.NDIlib_audio_frame_v3_t, *cgoAllocMap) {
	...
	var cp_metadata_allocs *cgoAllocMap
	ref7ee92be0.p_metadata, cp_metadata_allocs = copyPCharBytes((*sliceHeader)(unsafe.Pointer(&x.PMetadata)))
...
func (x *AudioFrameV3T) Deref() {
	...
	hxf3b8dbd := (*sliceHeader)(unsafe.Pointer(&x.PMetadata))
	hxf3b8dbd.Data = unsafe.Pointer(x.ref7ee92be0.p_metadata)
	hxf3b8dbd.Cap = 0x7fffffff
	// hxf3b8dbd.Len = ? x.PMetadata x.ref7ee92be0.p_metadata
